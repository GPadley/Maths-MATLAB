...
Therefore by making v = 0.45, thus never becoming unstable, if the x direction step size is changes, we can calculate k by multiplying it by $h^2 \hspace{5mm} \text{due to} \hspace{5mm} v = \frac{k}{h^2} \hspace{5mm} \text{we also replaced the} \hspace{2mm} 1-2v \hspace{2mm} \text{with} \hspace{2mm} \beta $.
...
title 'Finite Difference of PDE 1D Heat Equation - sin(2 {\pi} x)'
xlabel 'Distance/cm'
...
\subsubsection{0 Boundary Conditions - Conditions Met}

\begin{wrapfigure}{r}{0.5\textwidth}
    \vspace{-5mm}
  		\includegraphics[width=0.48\textwidth]{Ex4_Figs/FiniteTent.png}
	\vspace{-4mm}
  	\caption{$T_{in}(t)= tent(x)$}
  		\includegraphics[width=0.48\textwidth]{Ex4_Figs/FiniteSine.png}
	\vspace{-4mm}
  	\caption{$T_{in}(t)= sin(2{\pi}x)$}
    \includegraphics[width=0.48\textwidth]{Ex4_Figs/FiniteSineabs.png}
    \vspace{-4mm}
    \caption{$T_{in}(t)= |sin(2{\pi}x)|$}
  	\label{fig:ex4g1}
\end{wrapfigure}
...
\begin{wrapfigure}{l}{0.5\textwidth}
    \vspace{4mm}
  		\includegraphics[width=0.48\textwidth]{Ex4_Figs/sinpi.png}
	\vspace{-4mm}
  	\caption{$T_{in}(t)= sin({\pi}x)$}
\end{wrapfigure}
